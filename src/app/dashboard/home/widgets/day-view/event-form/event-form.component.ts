...
export class EventFormComponent implements OnInit {
  ...
  onSaveEventActivity(){
    let event: EventActivity = new EventActivity("", this.authService.authenticatedUser.id, this.getStartTimeISOString(), this.getEndTimeISOString(), this.newEventActivityForm.get('description').value, this.newEventActivityForm.get('category').value );
