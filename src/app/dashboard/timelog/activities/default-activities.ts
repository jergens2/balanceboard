...
*/
activities.push(new CategorizedActivity('default_work','', 'Work', 'Time spent on jobs, career', 'TOP_LEVEL', '#cee3ff'));
...
*/
activities.push(new CategorizedActivity('default_maintenance','', 'Maintenance', 'Time spent on routine necessities', 'TOP_LEVEL', '#d4ffcc'));
...
activities.push(new CategorizedActivity('default_makeFood','', 'Make Food', 'Making / preparing food', 'default_maintenance',  '#d4ffcc'));
...
activities.push(new CategorizedActivity('default_householdChores','', 'Household Chores', 'Cleaning the house, sweeping, vacuuming, dusting, dishes, etc.', 'default_maintenance', '#d4ffcc'));
