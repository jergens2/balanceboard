...
import { DaybookSleepCycle } from '../../sleep-manager/sleep-profile/daybook-sleep-cycle.class';
...
export class DaybookTimeSchedule extends TimeSchedule {
    ...
    constructor(dateYYYYMMDD: string, startTime: moment.Moment, endTime: moment.Moment, sleepCycle: DaybookSleepCycle) {
