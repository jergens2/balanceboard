import { DaybookTimelogEntryDataItem } from "../../../../../../daybook/api/data-items/daybook-timelog-entry-data-item.interface";
...
export class TimelogEntryBuilder{
    ...
    public buildFromDataItem(dataItem: DaybookTimelogEntryDataItem): TimelogEntryItem{
        ...
        let timelogEntryItem: TimelogEntryItem = new TimelogEntryItem(startTime, endTime);
        ...
        if (timelogEntry) {
            if (timelogEntry.timelogEntryActivities.length > 0) {
                ...
                timelogEntry.timelogEntryActivities.sort((a1, a2) => {
                    ...
                    let foundActivity: ActivityCategoryDefinition = activityTree.findActivityByTreeId(activityEntry.activityTreeId);
